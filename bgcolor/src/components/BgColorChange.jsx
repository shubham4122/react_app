  ...
  return (
    <div class="flex flex-col justify-center space-y-2 md:flex-row md:space-x-2 md:space-y-0">
      ...
      <button
        ...
        class="rounded-md bg-purple-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-purple-600/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600"
      >
        Purple
      </button>
    </div>
